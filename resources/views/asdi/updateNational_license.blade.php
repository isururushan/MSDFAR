        ...
        <div class="col-lg-8 offset-md-2 offset-lg-2 col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form  ">
                        <div class="content">
                            <form class="text-left form-validate"  method="POST" action="{{route('asdi/national_license/update/update')}}">
                                <div class="card-body">
                                @csrf
                                <div class="row">
                                ...
                                {{------------------EEz license number---------------------------------------}}
                                 ...
                                 {{-------------------Boat No---------------------------------------}}
                                    ...
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        <label  >Distric</label>
                                        <br>
                                        <select class="selectpicker "  name="distric" value="distric"  required  title="Choose a distric...">
                                    ...
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        ...
                                        <select class="selectpicker"   name="landing_side" required data-live-search="true" required  title="Choose a land...">
                                    ...
                                    {{-------------------costal area---------------------------------------}}
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        <label  >Costal Area</label><br>
                                        <select class="selectpicker"   name="costal_area" required data-live-search="true" required  title="Choose a area...">
                                    ...
                                    {{-------------------Nets Type--------------------------------------}}
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        <label  >Nets Type</label><br>
                                        <select class="selectpicker"   name="nets_type" required data-live-search="true" required  title="Choose a nets...">
