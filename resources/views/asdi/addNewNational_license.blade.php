        ...
        <div class="col-lg-8 offset-md-2 offset-lg-2 col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form  ">
                        <div class="content">
                            <form class="text-left form-validate"  method="POST" action="{{route('asdi/national_license/addNew/add')}}">
                                <div class="card-body">
                                @csrf
                                <div class="row">
                                {{------------------EEz license number---------------------------------------}}
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        ...
                                        <input type="text" name="eez_license_number" value=""  required data-msg="Please enter license number" class="form-control">
                                 ...
                                 {{-------------------Boat No---------------------------------------}}
                                    ...
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        ...
                                        <input type="text" name="fish_type" value=""  required data-msg="Please enter fish type" class="form-control">
                                    ...
                                    <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                        ...
                                        <select class="selectpicker"   name="nets_type" multiple data-live-search="true" required  title="Choose a nets...">
