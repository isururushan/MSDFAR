            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="info d-flex align-items-center">
                        <div class="content">
                            <div class="logo">
                                <h1>Department of Fisheries & Aq.Resources</h1>
                            </div>
                            <p>This website that search and view for visiters</p>
                        </div>
                    </div>
                </div>
                <!-- Form Panel    -->
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            ...
                            <br>
                            <br>
                            <a href="{{ route('register') }}" class="signup">Signup as fishermen</a>
                            <br>
                            <a href="{{ route('register/director') }}" class="signup">Signup as director</a>
                            <br>
                            <a href="{{ route('register/asdi') }}" class="signup">Signup as Asid</a>
                            <br>
                            <a href="{{ route('register/dofficer') }}" class="signup">Signup as dofficer</a>
