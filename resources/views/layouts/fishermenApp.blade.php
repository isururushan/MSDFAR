        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header">
                ...
                <a href="{{route('/')}}" class="navbar-brand">
                    <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">D</strong><strong>F</strong><strong>A</strong><strong>R</strong></div>
...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar">
                <a href="{{route('fishermen')}}"> <img src="{{asset('Profilepic/'.Auth::user()->avatar)}}" alt="..." class="img-fluid rounded-circle"></a>  </div>
            <div class="title">
        ...
        <li class=" {{ Request::path() == 'fishermen' ? 'active' : '' }} "><a href="{{route('fishermen')}}"> <i class="icon-home"></i>Home </a></li>
        {{-------------------------Boat-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'boat' ? 'active' : '' }}"><a href="#boatdropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-ship"></i>Boats</a>
                <ul id="boatdropdown" class="collapse list-unstyled ">
                      <li><a href="{{route('fishermen/boat/allView')}}">Boat List</a></li>
                </ul>
            </li>
        {{-------------------------National license-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'national_license' ? 'active' : '' }}"><a href="#national_licensedropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-id-card"></i>National license</a>
                <ul id="national_licensedropdown" class="collapse list-unstyled ">
                       <li><a href="{{route('fishermen/national_license/allView')}}">National license List</a></li>
                </ul>
            </li>
