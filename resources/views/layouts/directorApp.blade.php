...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar">
                <a href="{{route('director')}}"> <img src="{{asset('Profilepic/'.Auth::user()->avatar)}}" alt="..." class="img-fluid rounded-circle"></a>  </div>
            <div class="title">
        ...
        <li class=" {{ Request::path() == 'director' ? 'active' : '' }} "><a href="{{route('director')}}"> <i class="icon-home"></i>Home </a></li>
        ...
        {{-------------------------Fishermen-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'fishermen' ? 'active' : '' }}"><a href="#fishermendropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i>Fishermens</a>
                <ul id="fishermendropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('director/fishermen/allView')}}">Profile</a></li>
                </ul>
            </li>
            {{-------------------------Assistant Director-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'asdi' ? 'active' : '' }}"><a href="#asdidropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i>Assistant Directors</a>
                <ul id="asdiropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('director/asdi/allView')}}">Profile</a></li>
                </ul>
            </li>
            {{-------------------------Do Officer-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'dofficer' ? 'active' : '' }}"><a href="#dofficerdropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i>Do Officers</a>
                <ul id="dofficerdropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('director/dofficer/allView')}}">Profile</a></li>
                </ul>
            </li>
        ...
        {{-------------------------Boat-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'boat' ? 'active' : '' }}"><a href="#boatdropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-ship"></i>Boats</a>
                <ul id="boatdropdown" class="collapse list-unstyled ">
                      <li><a href="{{route('director/boat/allView')}}">Boat List</a></li>
                </ul>
            </li>
        {{-------------------------National license-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'national_license' ? 'active' : '' }}"><a href="#national_licensedropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-id-card"></i>National license</a>
                <ul id="national_licensedropdown" class="collapse list-unstyled ">
                       <li><a href="{{route('director/national_license/allView')}}">National license List</a></li>
                </ul>
            </li>
        ...
        <footer class="footer">
            <div class="footer__block block no-margin-bottom">
                <div class="container-fluid text-center">
                    <p class="no-margin-bottom">2021 &copy; DFAR System Design by <a href="https://HND.lk">HNDIT@2K</a></p>
                </div>
            </div>
        </footer>
</div>
