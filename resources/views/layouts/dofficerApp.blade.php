...
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            <div class="avatar">
                <a href="{{route('dofficer')}}"> <img src="{{asset('Profilepic/'.Auth::user()->avatar)}}" alt="..." class="img-fluid rounded-circle"></a>  </div>
            <div class="title">
        ...
        <li class=" {{ Request::path() == 'dofficer' ? 'active' : '' }} "><a href="{{route('dofficer/profile')}}"> <i class="icon-home"></i>Home </a></li>
        ...
        {{-------------------------Fishermen-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'fishermen' ? 'active' : '' }}"><a href="#fishermendropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i>Fishermens</a>
                <ul id="fishermendropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('dofficer/fishermen/addNew')}}">Add New</a></li>
                    <li><a href="{{route('dofficer/fishermen/allProfiles')}}">Profile</a></li>
                </ul>
            </li>
        {{-------------------------Boat-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'boat' ? 'active' : '' }}"><a href="#boatdropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-ship"></i>Boats</a>
                <ul id="boatdropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('dofficer/boat/addNew')}}">Add New Boat</a></li>
                    <li><a href="{{route('dofficer/boat/allView')}}">Boat List</a></li>
                </ul>
            </li>
        {{-------------------------National license-------------------------------------------------------}}
            <li class ="{{ Request::segment(2) == 'national_license' ? 'active' : '' }}"><a href="#national_licensedropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-id-card"></i>National license</a>
                <ul id="national_licensedropdown" class="collapse list-unstyled ">
                    <li><a href="{{route('dofficer/national_license/addNew')}}">Add New National license</a></li>
                    <li><a href="{{route('dofficer/national_license/allView')}}">National license List</a></li>
                </ul>
            </li>
</ul>
</nav>
