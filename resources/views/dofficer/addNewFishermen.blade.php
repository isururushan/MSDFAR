...
@stop
@section('pageHeader')
    Create New Fishermen
@stop
@section('breadcrumb')
    <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dofficer')}}">Home</a></li>
        <li class="breadcrumb-item active"> Create New Fishermen </li>
    </ul>
@stop
@section('content')
        ...
        <div class="col-lg-8 offset-lg-2">
            ...
            <div class="card ">
                <div class="card-header">
                    <h4 class="card-title">Add New Fishermen</h4>
                </div>
                <div class="container-fluid">
                    <form class="text-left form-validate"  method="POST" action="{{route('dofficer/fishermen/addNew/add')}}">
                        @csrf
                        <input type="hidden" name="role" value="fishermen">
                        <div class="row">
