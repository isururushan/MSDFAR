            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Boat Update</h4>
                        ...
                        <div class="form  ">
                            <div class="content">
                                <form class="text-left form-validate"  method="POST" action="{{route('dofficer/boat/update/update')}}">
                                    <div class="card-body">
                                    @csrf
                                    <div class="row">
                                    ...
                                    {{-------------------Boat No---------------------------------------}}
                                        ...
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                            <label  >Distric</label>
                                            <select class="selectpicker "  name="distric" required data-live-search="true" required  title="Choose a distric...">
