    ...
    <div class="row">
            ...
            <div class="card card-profile ">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="mb-4">Dofficer Since {{Auth::user()->created_at}} </p>
...
<!-- dofficer profile update -->
            <div class="col-lg-8  col-md-8">
                    ...
                    <div class="form  ">
                        <div class="content">
                            <form class="text-left form-validate"  method="POST" action="{{route('dofficer/profile/updateProfile')}}">
                                <div class="card-body">
                                @csrf
                                <div class="row">
                                {{-------------------First Name---------------------------------------}}
    ...
    <div class="modal fade" id="changepasswordModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form class="text-left form-validate"  method="POST" action="{{route('dofficer/profile/updatePassword')}}">
