                    ...
                    <table id="national_licenseTable" class="table dataTable no-footer"  aria-describedby="datatable1_info">
                        ...
                        @foreach($national_licenses as $national_license)
                            <tr role="row" class="odd">
                                ...
                                <td><a  href="{{route('dofficer/national_license/update/',$national_license->id)}}"  class="btn btn-outline-success">Update</a></td>
                                <td><a  href="{{route('dofficer/national_license/delete/',$national_license->id)}}" data-toggle="confirmation" data-title="Delete National_license?" class="btn btn-outline-danger">Delete</a></td>
                              </tr>
                        @endforeach
                        </tbody>
                    </table>
