            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create New Boat</h4>
                        ...
                        <div class="form  ">
                            <div class="content">
                                <form class="text-left form-validate"  method="POST" action="{{route('dofficer/boat/addNew/add')}}">
                                    <div class="card-body">
                                    @csrf
                                    <div class="row">
                                    {{------------------Boat Name---------------------------------------}}
                                        ...
                                        <label> Boat Name</label>
                                            <input type="text" name="boat_name"   required data-msg="Please enter boat name" class="form-control">
                                    ...
                                    {{-------------------Boat No---------------------------------------}}
                                            <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                                <label>Boat No</label>
                                                <input type="text" name="boat_no"   required data-msg="Please enter boat no" class="form-control">
                                                <small class="help-block-none"></small>
                                            </div>
                                        ...
                                        {{-------------------Fishermen Id---------------------------------------}}
                                            <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
                                                ...
                                                <input type="text" name="fishermen_id"   required data-msg="Please enter fishermen id" class="form-control">
                                                <small class="help-block-none"></small>
                                            </div><br>
                                        {{-------------------landing side---------------------------------------}}
                                        <div class="form-group-material col-md-6 col-sm-12 col-lg-6">
