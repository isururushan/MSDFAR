                    ...
                    <table id="boatTable" class="table dataTable no-footer"  aria-describedby="datatable1_info">
                        ...
                        @foreach($boats as $boat)
                            <tr role="row" class="odd">
                                ...
                                <td><a  href="{{route('dofficer/boat/update/',$boat->id)}}"  class="btn btn-outline-success">Update</a></td>
                                <td><a  href="{{route('dofficer/boat/delete/',$boat->id)}}" data-toggle="confirmation" data-title="Delete Boat?" class="btn btn-outline-danger">Delete</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
