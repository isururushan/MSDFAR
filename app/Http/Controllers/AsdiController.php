...
class AsdiController extends Controller
{
 /**
...
public function index()
{
    ...
    return view('asdi.dashboard',['fishermens'=>$fishermens ,'boats'=>$boats,'national_licenses'=>$national_licenses]);
}
...
public function profile()
            {
                $asdi = Asdi::where('user_id','=',Auth::user()->id)->first();
                return view('asdi.profile',['asdi'=>$asdi]);
            }
//---------------Asdi profile & password change query----------------------------
...
public function updateProfile(Request $request)
    {
            ...
            $getAsdi = Asdi::where('user_id','=',Auth::user()->id)->first();

            $asdi= Asdi::find($getAsdi->id);
...
public function showAddNewFishermenPanel()
            {
                return view('asdi.addNewFishermen');
            }
...
public function addNewFishermen(Request $request)
        {
            ...
            if($user->save())
            {
                ...
                if($fishermen->save())
                {
                    return redirect('asdi/fishermen/addNew')->with('success','fishermen Successfully added.Add another one');
                }
                else
                {
...
public function fishermenProfiles()
        {
            ...
            return view('asdi.allFishermenProfiles',['fishermens'=>$fishermen]);
        }
...
public function addNewBoat(Request $request)
        {
            ...
            if($boat->save())
            {
                return redirect('asdi/boat/addNew')->with('success','Boat register successfully Add');
            }
...
public function allBoat()
        {
            ...
            return view('asdi.allBoatView',['boats'=>$boat]);
        }
//-------------------view boat update panel----------------------------------
public function viewUpdateBoat($id)
        {
            $boat= Boat::find($id);
            return view('asdi.updateBoat',['boat'=>$boat]);
        }
...
public function updateBoat(Request $request)
        {
            ...
            if($boat->save())
            {
                return redirect('asdi/boat/allView')->with('success','Boat Successfully Updated.');
            }
            else
            {
...
public function deleteBoat($id)
        {
            ...
            return redirect('asdi/boat/addNew')->with('success','success for Boat delete...');
        }
...
public function showAddNewNational_licensePanel()
        {
            return view('asdi.addNewNational_license');
        }
...
public function addNewNational_license(Request $request)
        {
            ...
            {
                return redirect('asdi/national_license/addNew')->with('success','National license register successfully Add');
...
public function allNational_license()
        {
            ...
            return view('asdi.allNational_licenseView',['national_licenses'=>$national_license]);
        }
...
public function viewUpdateNational_license($id)
        {
            ...
            return view('asdi.updateNational_license',['national_license'=>$national_license]);
        }
...
public function updateNational_license(Request $request)
        {
            ...
            if($national_license->save())
            {
                return redirect('asdi/national_license/allView')->with('success','National license update successfully...');
...
public function deleteNational_license($id)
        {
            ...
            return redirect('asdi/national_license/addNew')->with('success','National license delete...');
        }
